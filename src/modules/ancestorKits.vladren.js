...
(function(){
  ...
  function onInstall(targetChar, opts) {
    ...
    upsertAttr('hr_false_life_pb_multiplier', 0);
    ...
    if (typeof SpellbookHelper !== 'undefined') {
      SpellbookHelper.installAlwaysPrepared(charId, [
        { name: 'False Life', level: 1, school: 'Necromancy', range: 'Self', components: 'V,S,M', duration: '1 hour', effect: 'Gain [[ 1d4 + 4 + @{selected|hr_spellmod} + (@{selected|hr_pb} * @{selected|hr_false_life_pb_multiplier}) ]] temp HP as per spell.' },

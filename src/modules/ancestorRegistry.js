...
var AncestorRegistry = (function () {
  ...
  store({
    ...
    boonKey: 'MorvoxTinyTyrant',
    baseKit: {
      summary: 'Malice-fueled singularities and ego-driven spellcraft collapse the battlefield.',
      html: '<div style="font-family:inherit;font-size:13px;line-height:1.25;"><h3 style="margin:0 0 6px 0;">Morvox, Tiny Tyrant — Phenomenal Malice</h3><b>Phenomenal Malice.</b> Start each room with <b>0/6 Malice</b>. Gain 1 when your ancestor spells hit or force a failed save (once per target per turn) and when an elite or boss drops in your Event Horizon. You can spend Malice before rolling a spell to amplify it; unused Malice is lost at the end of the room.<br><br><b>Malice Options.</b><br><table style="width:100%;border-collapse:collapse;font-size:12px;"><thead><tr style="background:#1b1b1b;color:#f0f0f0;"><th style="border:1px solid #444;padding:4px;">Spend</th><th style="border:1px solid #444;padding:4px;">Benefit</th></tr></thead><tbody><tr><td style="border:1px solid #444;padding:4px;">1 Malice</td><td style="border:1px solid #444;padding:4px;">Add <b>+PB force</b> to the spell’s damage and pull the target <b>10 ft</b>.</td></tr><tr><td style="border:1px solid #444;padding:4px;">2 Malice</td><td style="border:1px solid #444;padding:4px;">Add <b>+2×PB force</b>; targets that fail a save are <b>slowed</b> until the end of their next turn.</td></tr><tr><td style="border:1px solid #444;padding:4px;">3 Malice</td><td style="border:1px solid #444;padding:4px;">Add <b>+3×PB force</b> and expand the area by <b>5 ft</b>; creatures knocked prone by the spell are also <b>restrained</b> until they stand.</td></tr></tbody></table><br><b>Dark Star (Action).</b> Hurl a compressed singularity at a creature within <b>120 ft</b>. Make a ranged spell attack for <b>4d10 force + spell mod</b> (plus Malice spent). On a hit, the target is dragged <b>10 ft</b> toward the impact and sheds dim light (advantage on the next attack against it before your turn ends).<br><br><b>Event Horizon (Action).</b> Choose a <b>15-ft ring</b> within 60 ft (10 ft empty interior). Creatures entering or starting in the ring make a <b>Str save</b> vs your DC. Fail: dragged to the center, <b>prone</b>, and speed is halved until your next turn. Success: they resist the pull and only take half Malice riders. The zone lasts until the start of your next turn.<br><br><b>Primordial Burst (1/room).</b> Detonate a point within <b>60 ft</b>; creatures in a <b>20-ft radius</b> make a <b>Con save</b>. Fail: <b>8d6 force + spell mod</b> (double Malice bonus). Success: half damage. Targets at or below half HP take <b>+PB force</b> and lose reactions until the start of your next turn.</div>',
      alwaysPreparedSpells: ['Dark Star', 'Event Horizon', 'Primordial Burst'],
      empowerments: []
    }
  });

...
var DevTools = (function () {
  ...
  function resetHandouts() {
    ...
    function hasAutoFooter(text) {
      ...
      if (normalized.indexOf('auto generated by hoard run') !== -1) {
        return true;
      }
      if (normalized.indexOf('auto generated by the hoard') !== -1) {
        return true;
      }
      if (normalized.indexOf('auto generated hoard run') !== -1) {
        return true;
      }
      return false;
    }

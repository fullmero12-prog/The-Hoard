...
var DevTools = (function () {
  ...
  function resetHandouts() {
    ...
    for (var h = 0; h < handouts.length; h += 1) {
      ...
      if (!shouldRemove && notes && notes.indexOf('Auto-generated by Hoard Run.') !== -1) {
        shouldRemove = true;
      }

      if (!shouldRemove && name && name.indexOf('— Kit (') !== -1) {
        if (notes && (notes.indexOf('Crimson Pact') !== -1 || notes.indexOf('Ancestor') !== -1)) {
          shouldRemove = true;
        }
      }
